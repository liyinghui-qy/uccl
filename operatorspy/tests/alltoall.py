...
def test_cpu(lib):
    ...
    data_size = 16
    send_recv_count = int(data_size/comm_size.value)
    ...
    lib.Alltoall(descriptor, ctypes.byref(send_data), send_recv_count, datatypes.CCL_INT, ctypes.byref(recv_data), send_recv_count, datatypes.CCL_INT, comm, None)
...
if __name__ == "__main__":
    ...
    lib.Alltoall.restype = c_void_p
    lib.Alltoall.argtypes = [c_void_p, c_void_p, c_int, c_int, c_void_p, c_int, c_int, c_void_p, c_void_p]
